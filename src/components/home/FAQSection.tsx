...
const faqs = [
  ...
  },
  {
    ...
    a: "Non, on n'est pas une banque. En revanche, on fait le lien avec nos partenaires bancaires pour monter un prêt étudiant à partir de 75 000 €, remboursable une fois diplômé et en poste.",
