        ...
        <div className="relative">
          ...
          <div ref={scrollRef} className="flex gap-5 overflow-x-auto scroll-smooth snap-x snap-mandatory scrollbar-hide pb-4" style={{ scrollbarWidth: "none" }}>
            {testimonials.map((t, i) => (
              <div key={i} className="snap-start shrink-0 w-[320px] bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                ...
                <p className="text-[#334155] text-sm leading-relaxed mb-4 italic flex-1">&ldquo;{t.quote}&rdquo;</p>
