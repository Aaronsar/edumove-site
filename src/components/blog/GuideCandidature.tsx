              ...
              <div className="space-y-3 mb-6">
                {[
                  ...
                  },
                  {
                    icon: CreditCard,
                    title: "Financement",
                    description: "Grâce au prêt étudiant garanti par l'État (à partir de 75 000 € avec notre banque partenaire), vous pouvez financer la totalité de vos études sans avancer un centime.",
                  },
                  {
                    icon: FileText,
