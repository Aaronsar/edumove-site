  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Non, on n'est pas une banque. Par contre on fait le lien avec nos partenaires bancaires pour mettre en place un prêt étudiant à partir de 75 000 €. Le principe : vous ne commencez à rembourser qu'une fois diplômé et en poste.",
        content: (
          <>
            Non, on n&apos;est pas une banque. Par contre on fait le lien avec nos partenaires bancaires pour mettre en place un prêt étudiant à partir de 75 000 €. Le principe : vous ne commencez à rembourser qu&apos;une fois diplômé et en poste. On explique tout dans notre article sur le <IL href="/financement">financement des études</IL>.
          </>
        ),
      },
      {
        q: "Comment fonctionne le prêt étudiant ?",
        a: "Grâce à notre partenariat bancaire, les étudiants accompagnés par Edumove peuvent accéder à un prêt étudiant garanti par l'État à partir de 75 000 €. Le remboursement ne commence qu'une fois diplômé et en activité professionnelle. C'est la solution la plus utilisée par nos étudiants.",
        content: (
          <>
            Grâce à notre partenariat bancaire, les étudiants accompagnés par Edumove peuvent accéder à un prêt étudiant garanti par l&apos;État à partir de 75 000 €. Le remboursement ne commence qu&apos;une fois diplômé et en activité professionnelle. C&apos;est la solution la plus utilisée par nos étudiants. Tous les détails dans notre <IL href="/financement">guide financement</IL>.
          </>
        ),
      },
      {
