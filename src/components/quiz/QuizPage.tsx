...
export default function QuizPage() {
  ...
  // Form rendu désormais via <DiplomaFormEmbed form="quizzFac" /> directement
  // dans le JSX (cf. modal section) — plus besoin d'init JS HubSpot.
          ...
          >
            ...
            >
              ...
              <div className="p-6 md:p-8">
                ...
                <DiplomaFormEmbed form="quizzFac" />
              </div>
            </motion.div>
          </motion.div>
        )}
